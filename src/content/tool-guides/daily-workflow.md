---
toolId: "daily-workflow"
title: "日常学习工作流"
sourceUrl: "https://github.com/PKUFlyingPig/cs-self-learning/blob/adce8e13789dc16aa6d1fbe163e9541736defae4/docs/%E5%BF%85%E5%AD%A6%E5%B7%A5%E5%85%B7/workflow.md"
...
![](/assets/images/tool-guides/daily-workflow/01-information-workflow.png)
...
![](/assets/images/tool-guides/daily-workflow/02-information-loss.png)
...
![](/assets/images/tool-guides/daily-workflow/03-document-processing.png)

### 有什么格式

文件格式依托于其展示的平台，所以在看有什么格式之前，可以罗列一下我平时获取信息的来源：

![](/assets/images/tool-guides/daily-workflow/04-information-sources.png)
...
![](/assets/images/tool-guides/daily-workflow/05-web-clipping.png)

对于论文和电子书而言如果格式本身就是 pdf 则万事大吉，但如果是其他格式则可以使用 calibre 进行转换：

![](/assets/images/tool-guides/daily-workflow/06-pdf-conversion.png)

现在利用 Obsidian 的 pdf 插件和其原生的 markdown 支持就可以畅快无比地做笔记并且在这些文章的对应章节进行无缝衔接地引用跳转啦（具体操作参考下文的“信息的处理”模块）。

![](/assets/images/tool-guides/daily-workflow/07-obsidian-pdf-notes.png)
...
![](/assets/images/tool-guides/daily-workflow/08-cross-device-collection.png)
...
![](/assets/images/tool-guides/daily-workflow/09-rss-reading.png)
...
![](/assets/images/tool-guides/daily-workflow/10-word-translation.png)
...
![](/assets/images/tool-guides/daily-workflow/11-english-dictionary.png)
...
![](/assets/images/tool-guides/daily-workflow/12-language-reactor.png)
